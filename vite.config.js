  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        laserBikini: resolve(__dirname, "src/pages/laser-bikini.html"),
        laserLegs: resolve(__dirname, "src/pages/laser-legs.html"),
        laserArms: resolve(__dirname, "src/pages/laser-arms.html"),
  ...
  server: {
    ...
    historyApiFallback: {
      rewrites: [
        ...
        { from: /^\/services\/laser\/bikini/, to: "/pages/laser-bikini.html" },
        { from: /^\/services\/laser\/legs/, to: "/pages/laser-legs.html" },
        { from: /^\/services\/laser\/arms/, to: "/pages/laser-arms.html" },
